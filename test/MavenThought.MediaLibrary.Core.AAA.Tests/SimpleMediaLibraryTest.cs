...
namespace MavenThought.MovieLibrary.AAA.Tests
{
    ...
    public class SimpleMediaLibraryTest
    {
        ...
        /// System Under Test
        /// </summary>
        private SimpleMediaLibrary _sut;
        ...
        public void When_Adding_Should_Trigger_Event()
        {
            ...
            var handler = MockRepository.GenerateMock<EventHandler<MediaLibraryArgs>>();
        ...
        /// <summary>
        /// Tests that listing non violent movies returns empty
        /// </summary>
        [Test]
        public void When_ListingNV_Should_Return_Empty_If_All_Violent()
        {
            // By default a dynamic mock returns false
            // For movie1 the critic will return true
            _critic.Stub(c => c.IsViolent(Arg<IMovie>.Is.Anything)).Return(true);
            ...
            Assert.IsEmpty(actual, "The collection should be empty because all should be violent");
        }
